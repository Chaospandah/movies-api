...
Hey! I made a simple Movies API built with FastAPI. I'm currently practicing working with/creating API's, Git, and MDX/markdown for a dev-tools support role. 

## Tech Stack
- Python
- FastAPI
- Uvicorn
- Markdown / MDX for documentation
- Git & GitHub
...
### API
I created a quick API to keep on practicing working with them. Honestly having a lot of fun working with API's as of right now.
